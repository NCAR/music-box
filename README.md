...
box_model.initial_conditions = Conditions(temperature=300.0, pressure=101000.0, concentrations={ "A": 1.0, "B": 3.0, "C": 5.0})
...
box_model.add_evolving_condition(300.0,Conditions(temperature=290.0, pressure=100200.0, concentrations={"A": 1.0, "B": 3.0, "C": 10.0}))
