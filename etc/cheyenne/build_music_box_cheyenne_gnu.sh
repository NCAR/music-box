...
mv $SUITE_SPARSE_HOME/lib $SUITE_SPARSE_HOME/shared_lib
mkdir -p $SUITE_SPARSE_HOME/lib
cp $SUITE_SPARSE_ROOT/AMD/Lib/* $SUITE_SPARSE_HOME/lib
cp $SUITE_SPARSE_ROOT/BTF/Lib/* $SUITE_SPARSE_HOME/lib
cp $SUITE_SPARSE_ROOT/COLAMD/Lib/* $SUITE_SPARSE_HOME/lib
cp $SUITE_SPARSE_ROOT/KLU/Lib/* $SUITE_SPARSE_HOME/lib
cp $SUITE_SPARSE_ROOT/SuiteSparse_config/* $SUITE_SPARSE_HOME/lib
