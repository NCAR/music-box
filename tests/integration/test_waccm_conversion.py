...
def test_waccm_to_music_box_conversion(temp_dir):
    ...
    try:
        os.symlink(os.path.join(sample_data_dir, "20250820", "wrfout_hourly_d01_2025-08-20_08-00-00"),
                   os.path.join(sample_data_dir, "20250820", "wrfout_hourly_d01_2025-08-20_08:00:00"))
